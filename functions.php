...
function single_post()
{
	...
	<textarea placeholder='write comment here' cols='70' class='pmb-cmnt-textarea' name='comment'>
</textarea>
...
function search_user(){
    ...
    $run_user = mysqli_query($con,$get_user);
        ...
        <div class='row'>
          ...
          title='$username' style='float:left; margin:10px;'/>
          </a>
          </div><br><br>
          <div class='col-sm-6'>
          <a style='text-decoration:nomne;cursor:pointer;color:#fff;' href='user_profile.php?u_id=$user_id'>
          <strong><h2>$f_name $l_name</h2></strong>
          <i><h2 style='color:yellow;font-size:1.3em'>$desc</h2></i>
          </a>
          </div>
          <div class='col-sm-3'>
